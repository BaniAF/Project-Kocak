 ...
 * @author BANI BANN
 */
public class KOCAK_1_3 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KOCAK_1_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
